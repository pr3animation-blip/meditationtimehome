  ...
  return (
    <footer className="border-t border-border bg-sidebar text-sidebar-foreground">
      <div className="container mx-auto max-w-screen-2xl px-4 py-12 md:px-8">
              ...
              <ul className="space-y-2">
                {section.links.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-sidebar-foreground/60 transition-colors hover:text-sidebar-primary"
                    >
                      {link.title}
                    </Link>
                  </li>
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-sm text-sidebar-foreground/50 md:flex-row">
          <p>
